...
<div class="sidebar" id="mainSidebar">
    ...
    <nav>
        ...
        <a href="kelola_guru.php" class="nav-link <?= $cur === 'kelola_guru.php' ? 'active' : '' ?>"><span>&#128104;&#8205;&#127979;</span><span class="side-label">Kelola Guru</span></a>
        <a href="kelola_siswa.php" class="nav-link <?= $cur === 'kelola_siswa.php' ? 'active' : '' ?>"><span>&#127891;</span><span class="side-label">Kelola Siswa</span></a>
        <a href="kelola_kelas.php" class="nav-link <?= $cur === 'kelola_kelas.php' ? 'active' : '' ?>"><span>&#127978;</span><span class="side-label">Kelola Kelas</span></a>
        <a href="laporan.php" class="nav-link <?= $cur === 'laporan.php' ? 'active' : '' ?>"><span>&#128196;</span><span class="side-label">Rekap Absensi</span></a>
