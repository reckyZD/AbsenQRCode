...
<div class="sidebar" id="mainSidebar">
    ...
    <div class="sidebar-profile">
        ...
        <div class="side-role">Siswa</div>
        <div class="side-schoolname"><?= htmlspecialchars(NAMA_SEKOLAH) ?></div>
        <a href="profil.php" class="edit-profil-link">&#9998;&#65039; Edit Profil</a>
    </div>

    <nav>
        <a href="dashboard.php" class="nav-link <?= $cur === 'dashboard.php' ? 'active' : '' ?>"><span>&#128247;</span><span class="side-label">Scan Absen</span></a>
        <a href="riwayat_absen.php" class="nav-link <?= $cur === 'riwayat_absen.php' ? 'active' : '' ?>"><span>&#128196;</span><span class="side-label">Riwayat Absen Saya</span></a>
